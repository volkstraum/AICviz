...
### Project Overview
Hi there :) Welcome to **AICviz**. This project is a demonstration of my techincal capabilities in fetching data with API, data cleanup, and visualization utilizing various Python libraries.
